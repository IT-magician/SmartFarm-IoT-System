...
cd /home/pi/doorLock
wget https://raw.githubusercontent.com/jangsungLee/SmartFarm-IoT-System/master/Shell_Script/install-qt_build_environment.sh
chmod +x install-qt_build_environment.sh
sudo ./install-qt_build_environment.sh

echo "중재자 IP를 ${MEDIATOR_IP_ADDRESS}으로 설정합니다."

wget https://github.com/jangsungLee/SmartFarm-IoT-System/Shell_Script/raw/master/QT_Project/doorLock_System
